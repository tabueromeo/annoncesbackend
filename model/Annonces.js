...
function addannonce(req, res) {
	...
	donnee["reference"] =
		"LVS" +
		(datecurent.getFullYear() +
			datecurent.getMonth() +
			datecurent.getDay() +
			datecurent.getHours() +
			datecurent.getMinutes() +
			datecurent.getSeconds()) +
		donnee.iduser.substring(donnee.iduser.length - 4, donnee.iduser.length);
